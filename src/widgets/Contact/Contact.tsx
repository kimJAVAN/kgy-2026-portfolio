              ...
              <Card>
                ...
                <div className="space-y-4">
                  {SOCIAL_LINKS.map((link) => {
                    ...
                    const value = link.url.replace(
                      isEmail ? 'mailto:' : 'https://',
                      ''
                    );
                    ...
                    if (isEmail) {
                      return (
                        <button
                          key={link.name}
                          type="button"
                          onClick={() => handleEmailCopy(value)}
                          className="w-full text-left flex items-center gap-4 p-3 rounded bg-black/40 border border-emerald-500/20 hover:border-emerald-500/50 transition-all group"
                        >

      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-3 text-2xl md:text-4xl pt-4">
          ...
          <div className="max-w-2xl space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center space-x-3 bg-gray-900/40 border border-gray-800 px-5 py-3 rounded-full">
          ...
          <div className="flex flex-wrap gap-6">
            <a
              href="#projects"
              className="px-8 py-4 bg-green-500 hover:bg-green-600 text-black font-bold rounded-xl transition-all duration-300 flex items-center space-x-2 group shadow-lg shadow-green-500/20"
            >
              <span>프로젝트 보기</span>
            ...
            <a
              href="#contact"
              className="px-8 py-4 bg-transparent border-2 border-gray-700 text-gray-300 hover:border-green-500 hover:text-green-400 font-bold rounded-xl transition-all duration-300"
            >
              연락하기
            </a>
          </div>
